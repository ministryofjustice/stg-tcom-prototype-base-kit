# Experimental Prototype kit copy for Service Transformation Group prototypes
...
## Required updates
This is based on the MOJ prototype template which sits (as of Feb 2025) on version 12, version 13 is available. This may need an update to be hosted on Cloud Platform.

## Hosting
It requires a namespace on the Cloud Platform, and [github actions secrets] in the repository settings which enable the CD workflow. This is achieved via the the Cloud Platform guide on how to [Publish prototypes on the web].
